...
const REFERENCE_CONTENT: ReferenceContent[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        tone: "danger",
        label: "Problem",
        text: "Auf den Portalen wird Extrawurst neben vielen anderen Anbietern gelistet. Außerdem ist die Sichtbarkeit begrenzt auf die geringe monatliche Anzahl der Seitenbesucher der Plattformen. Vorherige Versuche, über Social Media zusätzliche Partner zu gewinnen, waren mit mehr Aufwand verbunden als sie Ergebnisse gebracht haben.",
      },
      {
        icon: Lightbulb,
        label: "Lösung",
        text: "Die Angst, dass es irgendwann zu spät für die Selbstständigkeit sein könnte. Die Angst vor dem Scheitern. Die Sorge vor finanzieller Unsicherheit. Genau diese Schmerzpunkte seiner Zielgruppe haben wir in den neuen Videoanzeigen adressiert. Somit bewegen wir mehr Interessenten dazu, sich als potentieller Partner zu bewerben.",
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        tone: "neutral",
        label: "Ausgangssituation",
        text: "Immergrün ist ein bekannter Name in der deutschen Franchise-Landschaft. Trotz der beträchtlichen Partneranzahl ist die Zielstellung weiterhin auf Wachstum ausgerichtet. Es gibt weiterhin Standorte, die besetzt werden sollen. In manchen Fällen werden auch Nachfolger gesucht.",
      },
      {
        icon: AlertCircle,
        tone: "danger",
        label: "Problem",
        text: "Das Team um Immergrün hatte keine zeitlichen Kapazitäten, sich um das Schalten von Werbeanzeigen zu kümmern. Neben den täglichen Aufgaben wie Standortsuche, Finanzierungen, Schulungen und Gesprächen mit bestehenden Franchisenehmern blieb keine Zeit für das Wesentliche: Die Akquise von neuen Partnern.",
      },
      {
        icon: Lightbulb,
        tone: "signal",
        label: "Lösung",
        text: "Immergrün hat uns Bildmaterial zugesendet, aus dem wir im ersten Schritt neue Videoanzeigen entwickelt haben. An 5 konkreten Standorten laufen nun Werbekampagnen auf Social Media, auf die sich pro Woche zwischen 6 bis 8 Interessenten melden, um als neue Partner beim Franchise zu starten.",
      },
    ],
  },
];
